...
## Architecture Overview(for this repo)
...
└────────┬────────────┘
         ...
         ▼
┌─────────────────────┐
│   Origin Frame      │  ← GPT Image 2 (OpenAI)
...
### 2. Origin Frame Generation — GPT Image 2
...
response = client.images.generate(
    model="gpt-image-2",
    prompt=f"{scene_data['origin_image_prompt']}, cinematic 4k masterpiece, photorealistic",
    size="1536x1024",
    quality="high",
    n=1,
)
origin_image_url = response.data[0].url
```
...
- **Replicate** — GPT Image 2, Grok, Wan, Hunyuan, Minimax, Kling, LTX
